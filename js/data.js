  ...
  products: [
    {
      ...
      highlights: ["Classic Indian Tea Partner", "Energy Rich", "100% Vegetarian"],
      isFlashDeal: true,
      discount: 0,
      inStock: true
    },
    {
      ...
      highlights: ["Light & Crispy", "Classic Salted", "Ideal Party Snack"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      ...
      highlights: ["Sweet & Salty", "Golden Crunchy", "Tea-time favourite"],
      isFlashDeal: false,
      discount: 20,
      inStock: true
    },
    {
      ...
      highlights: ["Real Choco Chips", "Rich Cocoa", "Youth Favourite"],
      isFlashDeal: true,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Real Mango Pulp", "Juicy & Refreshing", "Best Served Chilled"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["Rich Butter Flavor", "Crisp Texture", "Baked to Perfection"],
      isFlashDeal: false,
      discount: 8,
      inStock: true
    },
    {
      ...
      highlights: ["Real Cashews", "Golden Baked", "Melt in Mouth"],
      isFlashDeal: true,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["Zero Trans Fat", "10 Essential Vitamins", "Crisp & Light"],
      isFlashDeal: false,
      discount: 8,
      inStock: true
    },
    {
      ...
      highlights: ["Rich Choco Cream", "Sugar Crystals", "Crisp Crust"],
      isFlashDeal: false,
      discount: 9,
      inStock: true
    },
    {
      ...
      highlights: ["High Dietary Fibre", "100% Whole Wheat", "No Added Preservatives"],
      isFlashDeal: false,
      discount: 8,
      inStock: true
    },
    {
      ...
      highlights: ["100% Pure Milk Butter", "Iconic Taste", "Must-have Breakfast Staple"],
      isFlashDeal: true,
      discount: 4,
      inStock: true
    },
    {
      ...
      highlights: ["UHT Treated", "No Preservatives", "Rich in Calcium & Protein"],
      isFlashDeal: false,
      discount: 3,
      inStock: true
    },
    {
      ...
      highlights: ["6.0% Milk Fat", "Rich & Creamy", "Energy Dense"],
      isFlashDeal: false,
      discount: 3,
      inStock: true
    },
    {
      ...
      highlights: ["100% Pure Milk Cheese", "Individually Wrapped", "Melts Easily"],
      isFlashDeal: true,
      discount: 7,
      inStock: true
    },
    {
      ...
      highlights: ["Natural Probiotics", "Thick & Creamy", "No Gelatin or Preservatives"],
      isFlashDeal: false,
      discount: 5,
      inStock: true
    },
    {
      ...
      highlights: ["Rich Aroma", "Traditional Granular Texture", "High Smoke Point"],
      isFlashDeal: false,
      discount: 6,
      inStock: true
    },
    {
      ...
      highlights: ["55% Cocoa", "Zero Added Milk Fat", "Antioxidant Rich"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Original Formula", "Best Served Ice Cold", "Iconic Refreshment"],
      isFlashDeal: true,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["Strong Fizzy Punch", "Spicy Cola Taste", "Taste the Thunder"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["Crisp Lemon Lime", "100% Clear", "Maximum Refreshment"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      id: "p21",
      name: "Maaza Mango Pulp Beverage",
      brand: "Coca-Cola",
      category: "Beverages",
      price: 35,
      mrp: 40,
      ...
      highlights: ["Alphonso Mango Touch", "Thick & Sweet", "Dildaar Mango Taste"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["Real Lemon Juice Touch", "Cloudy & Zesty", "Zero Caffeine"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Fruit Orange Flavour", "Vibrant & Fruity", "Caffeine Free"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Extra Carbonation", "Zero Sugar", "Pure Taste"],
      isFlashDeal: false,
      discount: 17,
      inStock: true
    },
    {
      ...
      highlights: ["Bold Cola Taste", "Sparkling Fizz", "Party Essential"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      id: "p26",
      name: "Mountain Dew Citrus Blast",
      brand: "PepsiCo",
      category: "Beverages",
      price: 40,
      mrp: 45,
      ...
      highlights: ["Neon Citrus Punch", "Caffeine Boost", "Darr Ke Aage Jeet Hai"],
      isFlashDeal: true,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Tangy Orange Flavor", "Sweet & Punchy", "Youthful Energy"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["100% Natural Flavors", "Caffeine Free", "Crisp & Clean"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["Instant Energy", "Berry Flavour", "With Taurine & B-Vitamins"],
      isFlashDeal: true,
      discount: 17,
      inStock: true
    },
    {
      ...
      highlights: ["Spicy Masala Flavor", "Farm-grown Potatoes", "Crisp Crunch"],
      isFlashDeal: true,
      discount: 14,
      inStock: true
    },
    {
      ...
      highlights: ["Cream & Onion Fusion", "Golden Crisp", "Crowd Favourite"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      ...
      highlights: ["Chatpata Masala", "Crunchy Corn Puffs", "100% Vegetarian"],
      isFlashDeal: true,
      discount: 11,
      inStock: true
    },
    {
      id: "p33",
      name: "Kurkure Chilli Chatka Namkeen",
      brand: "PepsiCo",
      category: "Snacks & Biscuits",
      price: 40,
      mrp: 45,
      ...
      highlights: ["Spicy Chilli Kick", "Tangy Twist", "Crunchy Texture"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["No Added Sugar", "Rich in Vitamin C", "Pure Fruit Goodness"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["1/4 Moisturising Cream", "Dermatologically Tested", "Doesn't Dry Skin"],
      isFlashDeal: true,
      discount: 12,
      inStock: true
    },
    {
      id: "p36",
      name: "Pears Pure & Gentle Glycerin Soap",
      brand: "HUL",
      category: "Personal Care",
      price: 55,
      mrp: 60,
      ...
      highlights: ["Pure Glycerin", "Gentle on Sensitive Skin", "Natural Oils"],
      isFlashDeal: false,
      discount: 8,
      inStock: true
    },
    {
      ...
      highlights: ["Activ Silver Formula", "10x Germ Protection", "Invigorating Cleanse"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Jasmine & Almond Oil", "Silky Smooth Foam", "Floral Perfume"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      id: "p39",
      name: "Sunsilk Lusciously Thick & Long",
      brand: "HUL",
      category: "Personal Care",
      price: 280,
      mrp: 320,
      ...
      highlights: ["Keratin Yoghurt Complex", "2x Thicker Looking Hair", "Nourishing Care"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["Milk Protein Formula", "Reduces Hair Fall", "Safe for Daily Use"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      ...
      highlights: ["100% Pure Jelly", "Triple Purified", "Heals Dry Cracked Skin"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["Stain Removal Particles", "Easy Dissolve", "Keeps Clothes Bright"],
      isFlashDeal: true,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["Bright Clean Technology", "Dazzling Whites", "Fresh Fragrance"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Power of 100 Lemons", "Zero Residue", "Gentle on Hands"],
      isFlashDeal: true,
      discount: 9,
      inStock: true
    },
    {
      ...
      highlights: ["Swad Apnepan Ka", "Rich Aroma", "Strong CTC Brew"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["High Flavour CTC", "Golden Amber Hue", "Wah Taj Taste"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Roasted Coffee & Chicory", "Instant Aroma", "Warm South Indian Heritage"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      ...
      highlights: ["8 Real Fruits Blend", "Smooth Spreadable", "Breakfast Classic"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["13 Potent Herbs", "Fights 7 Dental Problems", "Protects Enamel"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["NMR Tested Pure", "Zero Sugar Adulteration", "Natural Immunity Booster"],
      isFlashDeal: true,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["2x Immunity", "With Fresh Amla", "Clinically Proven"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      id: "p52",
      name: "Dabur Amla Nourishing Hair Oil",
      brand: "Dabur",
      category: "Personal Care",
      price: 180,
      mrp: 200,
      ...
      highlights: ["Natural Amla Extract", "Strengthens Roots", "Prevents Premature Greying"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      id: "p53",
      name: "Dabur Hajmola Regular Tablets",
      brand: "Dabur",
      category: "Snacks & Biscuits",
      price: 55,
      mrp: 65,
      ...
      highlights: ["Chatpata Digestive", "Traditional Spices", "Post-meal Favorite"],
      isFlashDeal: false,
      discount: 15,
      inStock: true
    },
    {
      ...
      highlights: ["0% Maida, 100% Atta", "Extra Soft Rotis", "High Dietary Fibre"],
      isFlashDeal: true,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["Molten Choco Core", "Pure Indulgence", "Warm & Serve"],
      isFlashDeal: true,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Rich Roasted Cashews", "Melt in Mouth", "Just like Mom's baking"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["Zesty Achaari Flavor", "Triangle Crisps", "Maximum Crunch"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      ...
      highlights: ["Non-sticky Noodles", "Dehydrated Vegetables", "Kids Favourite"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      ...
      highlights: ["Ready in 2 Minutes", "Signature Tastemaker", "Goodness of Iron"],
      isFlashDeal: true,
      discount: 7,
      inStock: true
    },
    {
      id: "p60",
      name: "Maggi Masala Noodles Value 4-Pack",
      brand: "Nestle",
      category: "Groceries & Staples",
      price: 55,
      mrp: 60,
      ...
      highlights: ["Family Pack Value", "Consistent Taste", "With Tastemaker Included"],
      isFlashDeal: false,
      discount: 8,
      inStock: true
    },
    {
      ...
      highlights: ["Sun-ripened Tomatoes", "Thick & Glossy", "Squeezy Pour"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      id: "p62",
      name: "Nescafe Classic Instant Pure Coffee",
      brand: "Nestle",
      category: "Beverages",
      price: 340,
      mrp: 380,
      ...
      highlights: ["100% Pure Coffee", "Rich Frothy Aroma", "Signature Red Cup Taste"],
      isFlashDeal: true,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Crisp Layered Wafers", "Smooth Milk Chocolate", "Iconic Snap"],
      isFlashDeal: true,
      discount: 11,
      inStock: true
    },
    {
      id: "p64",
      name: "Nestle Munch Crunchy Chocolate Bar",
      brand: "Nestle",
      category: "Snacks & Biscuits",
      price: 20,
      mrp: 25,
      ...
      highlights: ["Maximum Crunch", "Value Pack", "Delightful Munch"],
      isFlashDeal: false,
      discount: 20,
      inStock: true
    },
    {
      ...
      highlights: ["Thick & Milky Tea", "Dissolves Instantly", "Long Shelf Life"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["Mint Infused", "Potato & Gram Flour", "India's No. 1 Namkeen"],
      isFlashDeal: true,
      discount: 13,
      inStock: true
    },
    {
      ...
      highlights: ["Sweet & Sour Harmony", "Crunchy Peanuts", "Traditional Tea Snack"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      id: "p68",
      name: "Haldiram's Salted Moong Dal",
      brand: "Haldiram's",
      category: "Snacks & Biscuits",
      price: 120,
      mrp: 140,
      ...
      highlights: ["Protein Rich Snack", "Light & Non-Greasy", "Pure Moong Dal"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      id: "p69",
      name: "Haldiram's Classic Bhujia Sev",
      brand: "Haldiram's",
      category: "Snacks & Biscuits",
      price: 125,
      mrp: 145,
      ...
      highlights: ["Authentic Bikaneri Recipe", "Spicy Pepper Kick", "Crunchy & Fresh"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      id: "p70",
      name: "Haldiram's Royal Soan Papdi",
      brand: "Haldiram's",
      category: "Snacks & Biscuits",
      price: 140,
      mrp: 160,
      ...
      highlights: ["Flaky Delicate Texture", "Cardamom Aroma", "Dry Fruit Toppings"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["Vacuum Evaporated", "Iodine Enriched", "Free Flowing"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["Badi & Choti Patti Blend", "Rich Amber Liquor", "Desh Ki Chai"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      id: "p73",
      name: "Tata Tea Gold Fine Leaf Blend",
      brand: "Tata",
      category: "Beverages",
      price: 170,
      mrp: 190,
      ...
      highlights: ["15% Long Leaves", "Irresistible Aroma", "Golden Liquor"],
      isFlashDeal: true,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["Unpolished Dal", "No Water/Leather Polish", "High Plant Protein"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["Zero Chemical Polish", "Naturally Wholesome", "Rich Earthy Flavour"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      id: "p76",
      name: "Cinthol Original Germ Protection Soap",
      brand: "Godrej",
      category: "Personal Care",
      price: 40,
      mrp: 45,
      ...
      highlights: ["High 79% TFM", "Deodorant Action", "Protects Skin Health"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      id: "p77",
      name: "Good Knight Gold Flash Machine + Refill",
      brand: "Godrej",
      category: "Cleaning & Household",
      price: 75,
      mrp: 85,
      ...
      highlights: ["Flash Vapour Release", "Knocks Out Mosquitos", "Child Safe Mechanism"],
      isFlashDeal: true,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["Amino Shakti Formula", "Adds Natural Calcium", "Freshens Breath"],
      isFlashDeal: true,
      discount: 11,
      inStock: true
    },
    {
      id: "p79",
      name: "Colgate MaxFresh Spicy Red Gel",
      brand: "Colgate",
      category: "Personal Care",
      price: 95,
      mrp: 110,
      ...
      highlights: ["Cooling Crystals", "Spicy Freshness", "Long Lasting Confidence"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      ...
      highlights: ["100% Pure & Edible", "Triple Filtered", "Signature Blue Bottle"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      id: "p81",
      name: "Saffola Gold Blended Edible Oil",
      brand: "Marico",
      category: "Groceries & Staples",
      price: 175,
      mrp: 195,
      ...
      highlights: ["LOSORB Technology", "Natural Oryzanol", "Healthy Heart Oil"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["Natural Herbal Actives", "Soothes Toothache", "Strengthens Gums"],
      isFlashDeal: false,
      discount: 12,
      inStock: true
    },
    {
      ...
      highlights: ["Desi Cow Milk Ghee", "Easy to Digest", "Aromatic & Granular"],
      isFlashDeal: false,
      discount: 8,
      inStock: true
    },
    {
      ...
      highlights: ["Pasteurised Fresh", "Thick Froth for Chai", "Daily Nutrition"],
      isFlashDeal: false,
      discount: 3,
      inStock: true
    },
    {
      id: "p85",
      name: "Mother Dairy Classic Creamy Curd",
      brand: "Mother Dairy",
      category: "Dairy & Breakfast",
      price: 68,
      mrp: 72,
      ...
      highlights: ["Set Curd Format", "Cooling & Gut-Friendly", "Ready to Eat"],
      isFlashDeal: false,
      discount: 6,
      inStock: true
    },
    {
      ...
      highlights: ["Enriched with Vit A & D", "Light & Non-Sticky", "High Smoke Point"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      id: "p87",
      name: "Fortune Special Biryani Basmati Rice",
      brand: "Fortune",
      category: "Groceries & Staples",
      price: 425,
      mrp: 480,
      ...
      highlights: ["Aged Basmati Grains", "Elongates on Cooking", "Rich Fragrance"],
      isFlashDeal: true,
      discount: 11,
      inStock: true
    },
    {
      id: "p88",
      name: "MDH Chunky Chat Masala Powder",
      brand: "MDH",
      category: "Groceries & Staples",
      price: 55,
      mrp: 65,
      ...
      highlights: ["Tangy Chatpata Flavor", "Asli Masale Sach Sach", "Great on Salads & Fruit"],
      isFlashDeal: false,
      discount: 15,
      inStock: true
    },
    {
      ...
      highlights: ["Vibrant Natural Red Colour", "Mild Balanced Heat", "Slow Ground"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
    {
      id: "p90",
      name: "Everest Chicken Masala Powder",
      brand: "Everest",
      category: "Groceries & Staples",
      price: 45,
      mrp: 55,
      ...
      highlights: ["Taste with Aroma", "Coarse Ground", "Curry Masterpiece"],
      isFlashDeal: false,
      discount: 18,
      inStock: true
    },
    {
      ...
      highlights: ["Real Apple Juice Extract", "Bubbly Fizz", "Party Sensation"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["50-Step Purification", "Essential Added Minerals", "Safe & Pure"],
      isFlashDeal: false,
      discount: 20,
      inStock: true
    },
    {
      id: "p93",
      name: "Funfoods Crunchy Peanut Butter",
      brand: "Dr Oetker",
      category: "Dairy & Breakfast",
      price: 485,
      mrp: 540,
      ...
      highlights: ["26g Plant Protein", "Real Peanut Chunks", "Zero Cholesterol"],
      isFlashDeal: true,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["Clinically Proven", "Bio-available Nutrients", "Classic Malt Taste"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["34 Vital Nutrients", "100% Milk Protein", "Creamy Chocolate Taste"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      ...
      highlights: ["10x Stain Removal", "Kills 99.9% Germs", "Angled Spout Bottle"],
      isFlashDeal: true,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["100% Germ Protection", "pH Balanced", "Original Pine Scent"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      ...
      highlights: ["First Aid & Surface Cleansing", "Proven Antiseptic", "Doctors Choice"],
      isFlashDeal: false,
      discount: 11,
      inStock: true
    },
    {
      id: "p99",
      name: "Mortein Fast Knockdown Insect Killer Spray",
      brand: "Reckitt",
      category: "Cleaning & Household",
      price: 175,
      mrp: 195,
      ...
      highlights: ["Fast Knockdown Action", "Reaches Tight Corners", "Lemon Fragrance"],
      isFlashDeal: false,
      discount: 10,
      inStock: true
    },
    {
      id: "p100",
      name: "Amul Kool Kesar Almond Flavoured Milk",
      brand: "Amul",
      category: "Beverages",
      price: 30,
      mrp: 35,
      ...
      highlights: ["Real Kesar Aroma", "Rich & Refreshing", "Best Served Chilled"],
      isFlashDeal: false,
      discount: 14,
      inStock: true
    },
